/**
 * YouTube Stream Sync Library v2.1.0
 * Библиотека для создания виртуального 24/7 стрима из плейлиста
 * Полная блокировка контролов и оверлей для стрима
 */
(function(window) {
'use strict';
...
class YouTubeStreamSync {
    constructor(options = {}) {
        ...
        this.config = {
            ...
            keySource: options.keySource || 'url',
            keyParamName: options.keyParamName || 'stream_key',
            ...
            onKeyValidated: options.onKeyValidated || null
        };
